<template>
  <v-container fluid class="m-5">
   <v-container class="grey lighten-5 mt-3 ">
    ...
    <v-row>
      <v-col v-for="(item, index) in $store.state.content.projects.images" v-bind:key="index" col="12" md="4" class="mx-auto">
        <v-card color="#000839" dark :loading="isUpdating">
          ...
          <v-img height="200" :src="item.imgURL">
            <v-row>
